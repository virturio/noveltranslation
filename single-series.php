...
<!-- Series Info -->
<div class="flex gap-6 bg-nv-header rounded-lg p-6 series-container max-md:flex-col max-md:items-center max-md:p-2">
    <!-- Cover Section -->
...
<div class="bg-nv-header rounded-lg p-6 mt-6">
    <div class="border-b border-nv-border pb-4">
